    ...
    public BoardDetailDto ToDetailDto(Board board, List<Long> photoId, User visitor){
        ...
        if (visitor == null){
            return BoardDetailDto.builder()
                    ...
                    .photoId(PhotoList)
                    .comments(commentRepository.findByBoardId(board.getId()).stream().map(comment -> commentMap.tolistDto(comment,null)).collect(Collectors.toList()))
                    .views(board.getView())
            ...
            return BoardDetailDto.builder()
                    ...
                    .writedTime(board.getWriteTime())
                    .photoId(PhotoList)
                    .comments(commentRepository.findByBoardId(board.getId()).stream().map(comment -> commentMap.tolistDto(comment,visitor)).collect(Collectors.toList()))
                    .views(board.getView())
                    .commentsCount(commentRepository.countByBoardId(board.getId()))
                    .likes(likeBoardRepository.countByBoardId(board.getId()))
